    ...
    <div className="min-h-screen bg-ink text-bone flex flex-col items-center justify-center px-6 text-center">
      ...
      <div className="rise rise-3 mt-9 flex flex-wrap items-center justify-center gap-3">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-7 py-3.5 rounded-lg font-semibold tracking-wide border border-line text-ash hover:text-bone hover:border-brass/50 transition-colors"
        >
          Apply Here
        </a>
      </div>
